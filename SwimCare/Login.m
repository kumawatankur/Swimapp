...
//     NSString *valueToSave = @"someValu";
//        [[NSUserDefaults standardUserDefaults] setObject:valueToSave forKey:@"preferenceNam"];
    ...
    if([[self.tx_userid text] isEqualToString:@""] || [[self.tx_pwd text] isEqualToString:@""] ) {
        ...
        //  if ([response statusCode] >= 200 && [response statusCode] < 300)
        {
            ...
            [[NSUserDefaults standardUserDefaults] synchronize];
                ...
                [self performSegueWithIdentifier:@"Invoices" sender:self];
            } else {
